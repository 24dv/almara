  ...
  return (
    <div className="relative w-full min-h-screen almara-gradient-bg animate-fade-in">
      ...
      <section className="h-screen flex items-center justify-center px-12 py-20 bg-[hsl(var(--almara-light-text))] partners-gradient-bg animate-fade-in">
        <div className="max-w-6xl mx-auto text-center relative z-10 reveal-up" style={{
          animationDelay: '0.2s',
      ...
      <section className="h-screen flex items-center justify-center px-12 py-20 bg-[hsl(var(--almara-light-text))] partners-gradient-bg">
        <div className="max-w-4xl mx-auto text-center relative z-10 reveal-up" style={{
          animationDelay: '0.2s',
          animationFillMode: 'both'
        }}>
          <div className="mb-16">
      ...
      <section className="h-screen flex items-center justify-center px-12 py-20 bg-[hsl(var(--almara-light-text))] partners-gradient-bg">
        <div className="max-w-4xl mx-auto text-center space-y-12 relative z-10 reveal-fade" style={{
          animationDelay: '0.2s',
          animationFillMode: 'both'
        }}>
