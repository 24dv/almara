          ...
          <div className="grid gap-8 grid-cols-3 max-w-3xl mx-auto mb-8">
            ...
            {[{
              ...
              <div key={p.name} className="relative group">
                ...
                {/* Hover Overlay */}
                <div className="absolute inset-0 rounded-xl opacity-0 group-hover:opacity-100 transition-all duration-300 z-[200] p-6 flex flex-col justify-center" style={{background: 'rgba(244, 234, 218, 0.14)', boxShadow: '0 4px 30px rgba(0, 0, 0, 0.1)', backdropFilter: 'blur(13.2px)', WebkitBackdropFilter: 'blur(13.2px)'}}>
