...
const Partners = () => {
  ...
  return (
    <div className="relative w-full min-h-screen almara-gradient-bg animate-fade-in">
      ...
      <section className="h-[50vh] lg:h-screen flex items-center justify-center px-4 sm:px-6 lg:px-12 py-4 sm:py-6 lg:py-20 bg-[hsl(var(--almara-light-text))] partners-gradient-bg">
