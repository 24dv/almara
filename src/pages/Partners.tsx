...
const Partners = () => {
  ...
  return (
    <div className="relative w-full min-h-screen almara-gradient-bg">
      ...
      <section className="h-screen flex flex-col almara-section-bg almara-soft-vignette">
      ...
      <section className="h-screen flex items-center justify-center px-12 py-20 almara-section-bg almara-soft-vignette relative z-20">
