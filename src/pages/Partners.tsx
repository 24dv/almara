  ...
  return (
    <div className="relative w-full min-h-screen almara-gradient-bg animate-fade-in">
      ...
      <section className="h-screen flex flex-col bg-[hsl(var(--almara-light-text))] partners-gradient-bg relative">
        ...
        {/* Background Circle */}
        <img src="/lovable-uploads/a58a04a2-6cc9-41d7-a8c1-bd70d0c8df8f.png" alt="Circle background" className="absolute w-[60vw] h-[60vw] max-w-[600px] max-h-[600px] min-w-[320px] min-h-[320px] object-cover bg-transparent top-[55%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-[5] reveal-fade pulse-breathing" style={{ animationDelay: '0.1s', animationFillMode: 'both' }} />
