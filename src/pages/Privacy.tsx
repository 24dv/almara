...
const Privacy = () => {
  ...
  return (
    <PageLayout title="Privacy Policy">
      <section className="min-h-screen flex items-start justify-center px-4 sm:px-8 lg:px-12 pt-24 lg:pt-32 pb-20">
        <div className="max-w-4xl mx-auto space-y-6 lg:space-y-8">
          ...
          <div ref={titleRef} className={`transition-all duration-1000 ease-out ${titleVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <h1 className="font-museo-moderno text-[24px] sm:text-[28px] lg:text-[32px] xl:text-[36px] text-[#f4eada] tracking-[0.05em] opacity-90 leading-tight text-center mb-8 lg:mb-12">
              Privacy Policy
            </h1>
          </div>
          
          {/* Content */}
          <div ref={contentRef} className={`space-y-4 lg:space-y-6 text-[#363636] font-helvetica-now leading-relaxed text-sm sm:text-base transition-all duration-1000 ease-out ${contentVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="space-y-3 lg:space-y-4">
              <h2 className="font-helvetica-now text-lg sm:text-xl tracking-wider font-bold text-[#364b56]">information we collect</h2>
              <p>
            ...
            <div className="space-y-3 lg:space-y-4">
              <h2 className="font-helvetica-now text-lg sm:text-xl tracking-wider font-bold text-[#364b56]">how we use your information</h2>
              <p>
            ...
            <div className="space-y-3 lg:space-y-4">
              <h2 className="font-helvetica-now text-lg sm:text-xl tracking-wider font-bold text-[#364b56]">information sharing and disclosure</h2>
              <p>
            ...
            <div className="space-y-3 lg:space-y-4">
              <h2 className="font-helvetica-now text-lg sm:text-xl tracking-wider font-bold text-[#364b56]">your rights</h2>
              <p>
            ...
            <div className="space-y-3 lg:space-y-4">
              <h2 className="font-helvetica-now text-lg sm:text-xl tracking-wider font-bold text-[#364b56]">contact information</h2>
              <p>
