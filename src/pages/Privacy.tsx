      ...
      <div className="max-w-4xl mx-auto px-8 py-16">
        ...
        <div className="prose prose-lg mx-auto text-almara-dark-text/80 font-helvetica-now">
          ...
          <div className="space-y-8">
            <section>
              <h2 className="text-2xl font-semibold text-almara-dark-text mb-4">Information We Collect</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-almara-dark-text mb-4">How We Use Your Information</h2>
              <p className="leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-almara-dark-text mb-4">Information Sharing</h2>
              <p className="leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-almara-dark-text mb-4">Data Security</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-almara-dark-text mb-4">Your Rights</h2>
              <p className="leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-almara-dark-text mb-4">Contact Us</h2>
              <p className="leading-relaxed">
