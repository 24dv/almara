...
const Mission = () => {
  ...
  return <div className="relative w-full min-h-screen almara-gradient-bg no-overlay animate-fade-in">
      ...
      <main className="relative z-10 min-h-[calc(100vh-200px)]">
       ...
       <section className="min-h-screen flex flex-col px-4 sm:px-6 md:px-8 lg:px-12 mission-section-gradient py-12 sm:py-16 md:py-20">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="max-w-lg text-center space-y-6 sm:space-y-8 reveal-up" style={{
            ...
            animationFillMode: 'both'
             ...
             <h1 className="font-museo-moderno text-[22px] sm:text-[26px] md:text-[30px] lg:text-[34px] xl:text-[36px] text-[#f4eada] tracking-[0.05em] opacity-90 leading-tight">Our Mission</h1>
      ...
      <section className="min-h-screen flex items-center justify-center px-4 sm:px-6 md:px-8 lg:px-12 mission-section-gradient py-16 sm:py-20">
        <div className="max-w-5xl mx-auto bg-gradient-to-r from-transparent via-gray-600/30 to-gray-700/60 rounded-3xl px-6 sm:px-12 md:px-16 lg:px-[120px] py-8 sm:py-12 md:py-[58px] backdrop-blur-sm">
          <div ref={pillarsHeaderRef} className={`text-center mb-6 sm:mb-8 transition-all duration-1000 ease-out ${pillarsHeaderVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <h2 className="font-museo-moderno text-[20px] sm:text-[24px] md:text-[28px] lg:text-[32px] xl:text-[36px] text-[#f4eada] tracking-[0.05em] opacity-90 leading-tight mb-6 sm:mb-8">Our Pillars</h2>
          </div>
          <div ref={pillarsContentRef} className={`space-y-6 sm:space-y-8 font-helvetica-now text-[#f4eada] transition-all duration-1000 ease-out ${pillarsContentVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <article className="text-center space-y-3 sm:space-y-4">
               <h3 className="font-helvetica-now text-base sm:text-lg md:text-xl tracking-wider font-bold text-[#b3bacb]">wisdom</h3>
            ...
            <article className="text-center space-y-3 sm:space-y-4">
               <h3 className="font-helvetica-now text-base sm:text-lg md:text-xl tracking-wider font-bold text-[#b3bacb]">grounded</h3>
            ...
            <article className="text-center space-y-3 sm:space-y-4">
               <h3 className="font-helvetica-now text-base sm:text-lg md:text-xl tracking-wider font-bold text-[#b3bacb]">simple</h3>
            ...
            <article className="text-center space-y-3 sm:space-y-4">
               <h3 className="font-helvetica-now text-base sm:text-lg md:text-xl tracking-wider font-bold text-[#b3bacb]">spirituality</h3>
      ...
      <section className="min-h-screen flex items-center justify-center px-4 sm:px-6 md:px-8 lg:px-12 mission-section-gradient py-16 sm:py-20">
        <div className="max-w-6xl mx-auto">
          <div ref={practiceHeaderRef} className={`text-center mb-12 sm:mb-16 transition-all duration-1000 ease-out ${practiceHeaderVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <h2 className="font-museo-moderno text-[20px] sm:text-[24px] md:text-[28px] lg:text-[32px] xl:text-[36px] text-[#f4eada] tracking-[0.05em] opacity-90 leading-tight">In Practice</h2>
          </div>
          <div ref={practiceGridRef} className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-12 font-helvetica-now text-[#f4eada] transition-all duration-1000 ease-out ${practiceGridVisible ? 'opacity-100 translate-y-0' : 'opacity-0 transform translate-y-8'}`}>
            <div className="flex items-start space-x-4">
              ...
              <div>
                 <h3 className="font-helvetica-now text-base sm:text-lg md:text-xl tracking-wider font-bold mb-4 text-[#b3bacb]">clarity first</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                 <h3 className="font-helvetica-now text-base sm:text-lg md:text-xl tracking-wider font-bold mb-4 text-[#b3bacb]">balance</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                 <h3 className="font-helvetica-now text-base sm:text-lg md:text-xl tracking-wider font-bold mb-4 text-[#b3bacb]">simplicity as rigour</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                 <h3 className="font-helvetica-now text-base sm:text-lg md:text-xl tracking-wider font-bold mb-4 text-[#b3bacb]">exploration & creativity</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                 <h3 className="font-helvetica-now text-base sm:text-lg md:text-xl tracking-wider font-bold mb-4 text-[#b3bacb]">community & belonging</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                 <h3 className="font-helvetica-now text-base sm:text-lg md:text-xl tracking-wider font-bold mb-4 text-[#b3bacb]">materiality · play</h3>
