  ...
  return <PageLayout title="About" noGradientOnMobile={true}>
      ...
      <section className="h-screen flex items-center justify-center px-4 sm:px-6 lg:px-12 py-16 sm:py-20">
        ...
        animationFillMode: 'both'
          ...
          {/* Main Tagline */}
          <h1 className="font-long-cang text-[28px] xs:text-[32px] sm:text-[36px] md:text-[32px] lg:text-[36px] xl:text-[40px] 2xl:text-5xl text-black tracking-[0.05em] opacity-90 leading-tight font-thin">
