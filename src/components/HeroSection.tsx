export const HeroSection = () => {
  return <section className="relative h-screen flex items-center justify-center almara-gradient-bg">
      ...
      <div className="relative z-10 text-center">
        {/* ALMARA Logo */}
        <div className="mb-8">
          <img src="/lovable-uploads/2c678d11-20a8-496a-9604-16c61d8ae172.png" alt="ALMARA" className="h-10 sm:h-14 md:h-18 lg:h-22 mx-auto opacity-90" />
        </div>
        
        {/* Subtitle */}
        <h2 className="font-helvetica-now font-bold text-lg sm:text-xl md:text-2xl lg:text-3xl text-almara-dark-text tracking-[0.2em] opacity-90">
