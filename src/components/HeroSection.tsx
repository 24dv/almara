export const HeroSection = () => {
  return <section className="relative min-h-screen flex items-center justify-center almara-gradient-bg">
      ...
      <img 
        ...
        className="absolute w-[1000px] h-[1000px] object-cover bg-transparent top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" 
      />
      ...
      <div className="relative z-10 text-center">
        {/* ALMARA Logo */}
        <div className="mb-8">
          <img src="/lovable-uploads/2c678d11-20a8-496a-9604-16c61d8ae172.png" alt="ALMARA" className="h-80 mx-auto opacity-90" />
        </div>
